	...
	<div class="top_bar">
		...
		<div class="search">
			...
			<form action="search.php" method="GET" name="search_form">
				<input type="text" onkeyup="getLiveSearchUsers(this.value, '<?php echo $userLoggedIn; ?>')" name="q" placeholder="Search for a user..." autocomplete="off" id="search_text_input">
